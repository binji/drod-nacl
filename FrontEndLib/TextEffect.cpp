// $Id: TextEffect.cpp 8036 2007-07-28 13:44:46Z mrimer $
...
//Draws text in the middle of the parent widget.
{
	...
	SDL_Rect rect = {this->screenRect.x + this->nX, this->screenRect.y + this->nY,
	...
	if (g_pTheBM->bAlpha)
	{
		...
		SDL_SetAlpha(this->pTextSurface,SDL_SRCALPHA,nOpacity);
	}
	else
		SDL_SetAlpha(this->pTextSurface,0,0); //Remove transparency.
