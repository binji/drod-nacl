// $Id: BitmapManager.h 10008 2012-03-24 19:40:12Z mrimer $
...
public:
	...
	void        BlitTileImagePart(const UINT wTileImageNo, const UINT x,
			...
			const bool bUseLightLevel=false, const Uint8 nOpacity=255);
	void        BlitTileShadows(UINT* pwShadowTIs, const UINT wNumShadows,
			const UINT x, const UINT y, SDL_Surface *pDestSurface);
	void        BlitTileShadowsWithTileMask(UINT* pwShadowTIs, const UINT wNumShadows,
	...
	static SDL_Surface* CreateNewSurfaceLike(SDL_Surface *pSrcSurface,
	...
	static void ScaleSimple(SDL_Surface *pSrcSurface, Uint8 *pSrcOrigin,
			const int srcWidth, const int srcHeight, SDL_Surface *pDestSurface);
	SDL_Surface* ScaleSurface(SDL_Surface *pSrcSurface, Uint8 *pSrcOrigin,
