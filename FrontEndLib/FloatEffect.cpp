// $Id: FloatEffect.cpp 8019 2007-07-14 22:30:11Z trick $
	...
	, wXSize(wXSize), wYSize(wYSize)
{
	...
	SDL_Rect rect = {static_cast<Sint16>(this->fX), static_cast<Sint16>(this->fY),
						  static_cast<Sint16>(wXSize), static_cast<Sint16>(wYSize)};
