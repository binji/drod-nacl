// $Id: HyperLinkWidget.cpp 9117 2008-08-05 04:04:05Z mrimer $
...
//Params:
	...
	: CLabelWidget(dwSetTagNo, nSetX, nSetY, wSetW, wSetH,
		eSetFontType, pwczSetText, bResizeToFit, wFirstIndent, WT_HyperLink)
...
/*
	return (nRelY < (int)(this->h - fonth))
		? (((UINT)nRelY >= fonth) ? true : ((UINT)nRelX >= GetFirstIndent()))
		: ((UINT)nRelX < GetLastWidth());*/
}
