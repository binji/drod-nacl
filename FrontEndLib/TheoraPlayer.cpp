// $Id: TheoraPlayer.cpp 8419 2007-11-30 22:02:45Z trick $
...
SDL_Overlay* open_video(SDL_Surface *screen)
//Prepares an overlay for video display to screen.
{
	SDL_Overlay *yuv_overlay = SDL_CreateYUVOverlay(ti.frame_width, ti.frame_height,
