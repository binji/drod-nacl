// $Id: Outline.cpp 10030 2012-03-29 07:00:37Z mrimer $
	...
	UINT wWidth)               //(in)   Width in pixels to make the outline.  Default is 1.
{
	...
	switch (pSurface->format->BytesPerPixel)
	{
		case 1:
		{
			const Uint8 OutlineSurfaceColor = (Uint8)SDL_MapRGB(pSurface->format, OutlineColor.r, 
					OutlineColor.g, OutlineColor.b);
			const Uint8 BackgroundSurfaceColor = (Uint8)pSurface->format->colorkey;
		...
		case 3:
		{
			SURFACECOLOR OutlineSurfaceColor = GetSurfaceColor(pSurface, OutlineColor.r, 
					OutlineColor.g, OutlineColor.b);       
			Uint8 r, g, b;
			SDL_GetRGB(pSurface->format->colorkey, pSurface->format, &r, &g, &b);
