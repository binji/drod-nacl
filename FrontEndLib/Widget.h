// $Id: Widget.h 9116 2008-08-05 04:03:28Z mrimer $
...
protected:
	...
	UINT       GetHotkeyTag(const SDL_keysym& keysym);
...
public:
	...
	void        AddHotkey(const SDLKey key, const UINT tag);
	...
	static void  TranslateUnicodeKeysym(WCHAR& wc, const SDLKey sym, const bool bCaps);
	...
	inline void UpdateRect(int nX, int nY, UINT wW, UINT wH) const
		{ SDL_Rect rect = {nX, nY, wW, wH}; UpdateRect(rect); }
