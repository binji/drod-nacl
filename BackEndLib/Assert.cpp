// $Id: Assert.cpp 8019 2007-07-14 22:30:11Z trick $
...
{
	char szGameName[CFiles::wGameName.length() + 1];
	UnicodeToAscii(CFiles::wGameName, szGameName);
	fprintf(stderr, "%s: %s", szGameName, pszMessage);
}
#endif
