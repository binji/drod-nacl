// $Id: IniFile.cpp 9483 2010-12-29 22:16:51Z mrimer $
...
{
	string strText;
	UnicodeToAscii(wstrText, strText);
	return LoadText(strText, bOverwrite, bAddDuplicates);
}
