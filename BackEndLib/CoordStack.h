// $Id: CoordStack.h 8019 2007-07-14 22:30:11Z trick $
...
public:
	...
	bool PopBottom(UINT &wX, UINT &wY)	//use to make stack behave as queue
	{
		...
		ROOMCOORD& first = this->data.front();
		wX = first.wX;
		wY = first.wY;
	...
	//Sets values in indexth element.
	{
		...
		//Set vars.
		this->data[wIndex].wX = wX;
		this->data[wIndex].wY = wY;
