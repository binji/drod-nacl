// $Id: Briar.h 9998 2012-03-24 17:33:24Z mrimer $
...
public:
	...
	CCoordSet getEdgeTilesFor(const UINT wX, const UINT wY) const;
...
private:
	void expand(CCueEvents &CueEvents, const UINT wIndex);
