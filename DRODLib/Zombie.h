// $Id: Zombie.h 9804 2012-01-14 21:26:02Z TFMurphy $
...
protected:
	enum DeflectType {
		GazeBlocked,   //same angle
		GazeReturned,  //perpendicular
		GazeDeflected  //45 degree offset
	};
	static DeflectType DeflectAngle(int& oX, int& oY, const UINT wInAngle, const UINT wDeflectSurface);
};
