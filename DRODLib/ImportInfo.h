// $Id: ImportInfo.h 9742 2011-10-22 16:12:27Z mrimer $
...
public:
	...
	CIDSet localHoldIDs;
	set<WSTRING> roomStyles; //room style references encountered in import
...
//Backwards compatibility:
	vector<CEntranceData*> LevelEntrances;   //1.6
	UINT  dwRepairHoldID;
	UINT  wVersion;
};
