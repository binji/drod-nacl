// $Id: DbLevels.h 9742 2011-10-22 16:12:27Z mrimer $
...
public:
	...
	CDbLevel*   MakeCopy(CDbHold *pNewHold, CImportInfo& info);
	UINT       SaveCopyOfRooms(const UINT dwNewLevelID, CImportInfo& info);
