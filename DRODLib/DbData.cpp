// $Id: DbData.cpp 10060 2012-03-31 13:47:22Z mrimer $
...
#define LONGTOSTR(val) _ltoa((val), dummy, 10)
	...
	str += LONGTOSTR(pData->wDataFormat);
	...
	bool &bSaveRecord)      //(out) whether record should be saved
{
	...
	switch (pType)
	{
		...
		case P_DataFormat:
			this->wDataFormat = static_cast<UINT>(atoi(str));
		break;
		case P_HoldID:
		{
