// $Id: DbBase.cpp 10002 2012-03-24 18:03:06Z mrimer $
...
bool CDbBase::IsOpen()
{
	return m_pMainStorage != NULL &&
			...
			m_pSaveStorage != NULL && m_pTextStorage != NULL;
}
...
//MID_Success or another message ID for failure.
{
	...
	bool bNeedToConvert3_0_1To3_0_2 = false, bFreshStart = false;
	...
	try
	{
		...
		wstrMainDatPath += CFiles::wGameVer;
		...
		{
			bNeedToConvert3_0_1To3_0_2 = true;
			if (!CreateDatabase(wstrHoldDatPath.c_str(), START_LOCAL_ID))
				return MID_DatNoAccess;
		}
		if (!CFiles::DoesFileExist(wstrPlayerDatPath.c_str()))
		{
			if (bNeedToConvert3_0_1To3_0_2)
				bFreshStart = true; //no data files at all -- no conversion needed
...
#else
		//The main dat MUST be opened as read-only, otherwise things
		//break horribly
		0  //0 = read-only
#endif
		);
...
//to GetMessageText.
{
	...
	switch (eMessageID)
	{
		case MID_RateHold: strText = "Rate this hold!"; break; //removed hotkey
		case MID_DRODUpgradingDataFiles: strText = "DROD is upgrading your data files." NEWLINE "This could take a moment.  Please be patient..."; break;
		case MID_DRODUpgradingDataFilesError: strText = "DROD was unable to complete upgrading your data files and will now exit. If the problem persists, please contact Caravel Games for support."; break;
		case MID_DRODUpgradingDataFilesPrompt: strText = "DROD must upgrade your data files for this game version to function. Do you wish to have DROD upgrade your files now (\"No\" exits)?"; break;
		case MID_No: strText = "&No"; break;
		case MID_Okay: strText = "&Okay"; break;
		case MID_ScoresNotUploaded: strText = "No scores were uploaded."; break;
		case MID_ScoresUploaded: strText = "Scores uploaded."; break;
		case MID_UploadingRoomConquerDemos: strText = "Sending room conquer solutions to server..."; break;
		case MID_Yes: strText = "&Yes"; break;
		case MID_ApplyToRoom: strText = "&Apply to Room"; break;
		case MID_ApplyToLevel: strText = "Apply to entire &Level"; break;
		case MID_BumpedMasterWall: strText = "Moves bumping into a closed" NEWLINE "Master Wall are not allowed."; break;
		case MID_DROD_TCB3_1: strText = "The City Beneath (3.1)"; break;
		case MID_DROD_UnsupportedVersion: strText = "Unsupported version"; break;
		case MID_Tunnel_N: strText = "Tunnel (north)"; break;
		case MID_Tunnel_E: strText = "Tunnel (east)"; break;
		case MID_Tunnel_S: strText = "Tunnel (south)"; break;
		case MID_Tunnel_W: strText = "Tunnel (west)"; break;
		case MID_DisplayingOtherRoom: strText = "(Displaying map room...)"; break;
		case MID_SetNPCAppearance: strText = "Set appearance"; break;
		case MID_DROD_TCB3_2: strText = "The City Beneath (3.2)"; break;
		case MID_SnakeLengthAffix: strText = "t"; break;
		case MID_NPCNoGhostDisplay: strText = "No ghost display"; break;
		case MID_NPCGhostDisplay: strText = "Ghost display"; break;
		case MID_Graphics: strText = "Graphics"; break;
		case MID_Sound: strText = "Sound"; break;
		case MID_DefaultDesktop: strText = "Default desktop"; break;
		case MID_DefaultLaptop: strText = "Default laptop"; break;
		case MID_DefaultKeyCommandsPrompt: strText = "Do you want to use the default key command settings?"; break;
		case MID_RoomNotScorable: strText = "This room does not record high scores."; break;
		...
		case MID_Levels: strText = "Levels"; break;
		case MID_DROD_TCB3_3: strText = "The City Beneath (3.3)"; break;
		case MID_MusicDefault: strText = "(Default music)"; break;
		case MID_PlayingCutScene: strText = "(Cut scene)"; break;
		case MID_TotalMoves: strText = "_TotalMoves"; break;
		case MID_TotalTime: strText = "_TotalTime"; break;
		case MID_VarSword: strText = "_Sword"; break;
		case MID_VarMonsterColor: strText = "_MyColor"; break;
		case MID_VarMonsterSword: strText = "_MySword"; break;
		case MID_VarMonsterX: strText = "_MyX"; break;
		case MID_VarMonsterY: strText = "_MyY"; break;
		case MID_VarMonsterO: strText = "_MyO"; break;
		case MID_VarMonsterParamX: strText = "_MyScriptX"; break;
		case MID_VarMonsterParamY: strText = "_MyScriptY"; break;
		case MID_VarMonsterParamW: strText = "_MyScriptW"; break;
		case MID_VarMonsterParamH: strText = "_MyScriptH"; break;
		case MID_VarMonsterParamF: strText = "_MyScriptF"; break;
		case MID_VarX: strText = "_X"; break;
		case MID_VarY: strText = "_Y"; break;
		case MID_VarO: strText = "_O"; break;
		default: break;
	}
