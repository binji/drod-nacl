// $Id: DbProps.h 9742 2011-10-22 16:12:27Z mrimer $
...
= {
	...
	"EntranceID", "ExploredRooms", "ExtraVars", "Flags", "GID_Created",
	"GID_LevelIndex", "GID_NewLevelIndex", "GID_OriginalNameMessage", "GID_PlayerID",
	"GlobalScripts", "HoldID", "ImageStartX", "ImageStartY", "IsFirstTurn",
	...
	"NameMessage", "NextDemoID", "O", "OrderIndex", "PlayerID",
	...
	"StartRoomWaterTraversal", "StartRoomX", "StartRoomY", "Stats",
