// $Id: Station.cpp 9742 2011-10-22 16:12:27Z mrimer $
...
//Returns: whether path map was recalculated, indicating other path maps must too
{
	...
	ASSERT(this->pRoom);
	this->pRoom->GetSwordCoords(CStation::swords);
...
const
{
	...
	switch (this->pRoom->GetOSquare(wX,wY))
	{
		...
		case T_WALL: case T_WALL2: case T_WALL_M: case T_WALL_IMAGE:
	...
	if (pMonster && pMonster->wType == M_ROCKGOLEM && !pMonster->IsAlive())
		return true;
