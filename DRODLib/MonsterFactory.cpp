// $Id: MonsterFactory.cpp 9742 2011-10-22 16:12:27Z mrimer $
...
//Pointer to a new instance of class derived from CMonster.
{
	...
	switch (eType)
	{
		...
		case M_SEEP:
		return new CGhost(this->pCurrentGame);
		...
		case M_HALPH2:
		return new CHalph2(this->pCurrentGame);
		...
		case M_SLAYER2:
		return new CSlayer2(this->pCurrentGame);
		...
		case M_STALWART2:
		return new CStalwart2(this->pCurrentGame);
