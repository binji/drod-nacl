// $Id: DRODUtil.cpp 9742 2011-10-22 16:12:27Z mrimer $
...
#define APPNAME   "DRODUtil v4.0"
const WCHAR wszDROD_VER[] = {{'4'},{'_'},{'0'},{0}};

static const WCHAR wszUniqueResFile[] = {
    We('f'),We('r'),We('o'),We('g'),We('s'),We('a'),We('n'),We('d'),We('m'),We('i'),We('c'),We('e'),We('0'),We('.'),We('d'),We('a'),We('t'),We(0) };
