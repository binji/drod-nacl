// $Id: v1_11c.cpp 9742 2011-10-22 16:12:27Z mrimer $
...
//True if successful, false if not.
{
	...
	char szDMOFilepath[wstrDMOFilepath.length()+1];
	UnicodeToAscii(wstrDMOFilepath, szDMOFilepath);
	HFILE hfileDMO = open(szDMOFilepath, O_RDONLY);
#endif
	if (hfileDMO == HFILE_ERROR) return false;
