// $Id: DrodSound.cpp 9905 2012-03-05 16:01:06Z mrimer $
...
const UINT DEFAULT_SOUND_VOLUME = 128, DEFAULT_MUSIC_VOLUME = 96, DEFAULT_VOICE_VOLUME = 255;
...
//True if successful, false if not.
{
	...
	switch (eSongID)
	{
		...
		case SONGID_ENDOFTHEGAME:	strKeyName = "Finale"; break;
