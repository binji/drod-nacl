// $Id: Chat.cpp 10007 2012-03-24 18:18:29Z mrimer $
...
//Returns: true if data received were valid, else false
{
	...
	if (bError)
	{
		...
		_snprintf(errorStr, 256,
				...
				size);
		CFiles Files;
		Files.AppendUserLog((char *)errorStr);
		Files.AppendUserLog(buf);	//output the problem text
	}
