// $Id: TrapdoorFallEffect.cpp 9742 2011-10-22 16:12:27Z mrimer $
	...
	, tileFallTime(tileFallTime)
{
	...
	SDL_Rect rect = {this->xTrapdoor, this->yTrapdoor, CBitmapManager::CX_TILE, CBitmapManager::CY_TILE};
...
//True if effect should continue, or false if effect is done.
{
	...
	SDL_Rect clipRect = {this->xTrapdoor, yPos,
	...
	SDL_Rect src = {0, clipRect.y - yPos, CBitmapManager::CX_TILE, clipRect.h};
