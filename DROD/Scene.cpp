// $Id: Scene.cpp 9742 2011-10-22 16:12:27Z mrimer $
...
//*****************************************************************************
bool Scene::lightShinesAt(const Point& Ro, Light *pLight)
...
//Returns: color of light at Ro
{
	...
	{
		SceneObject *pOccludingObject = this->objectHierarchy.intersectsAny(Ro, Ld, t);
		if (pOccludingObject)
			return false;
	}
