// $Id: TileImageCalcs.h 9854 2012-02-18 23:57:51Z mrimer $
...
void  CalcStairUpPosition(const CDbRoom *pRoom, const UINT wCol, const UINT wRow,
								UINT& wStairsCol, UINT& wStairsRow);
void  CalcTileCoordForPit(const CDbRoom *pRoom, const UINT wCol,
								  const UINT wRow, UINT& wX, UINT& wY, UINT& wWidth);
...
UINT  GetSwordTile(const UINT wType, const UINT wO);
...
static inline bool bShowsShadow(const UINT o) {
	return bIsFloor(o) || bIsOpenDoor(o) || bIsTunnel(o) || bIsWater(o) || bIsPlatform(o);
}
