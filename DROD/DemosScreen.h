// $Id: DemosScreen.h 9742 2011-10-22 16:12:27Z mrimer $
...
private:
	...
	enum DEMOTagType
	{
		...
		RoomNotConquered, //set if CNet records aren't sent because room isn't conquered for player on CNet
		RoomNotScorable,	//set if the room is not highscoreable on CNet
		Demo_Tag_Count,
		Unknown_Demo_Tag
	};
