// $Id: SelectPlayerScreen.cpp 9751 2011-10-22 20:17:52Z mrimer $
...
CSelectPlayerScreen::CSelectPlayerScreen() : CDrodScreen(SCR_SelectPlayer)
	...
	, pExportPlayerButton(NULL), pExportPlayerSavesButton(NULL), pImportPlayerButton(NULL)
...
//Constructor.
{
	...
	static const int X_IMPORTBUTTON = 140;
	...
	this->pImportPlayerButton = new CButtonWidget(
			TAG_IMPORT, X_IMPORTBUTTON, Y_BUTTONS3, CX_IMPORTBUTTON, CY_STANDARD_BUTTON,
