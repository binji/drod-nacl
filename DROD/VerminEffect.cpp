// $Id: VerminEffect.cpp 9787 2011-11-30 23:39:10Z mrimer $
	...
	, bSlayer(bSlayer)
{
	...
	for (UINT wIndex=wNumVermin; wIndex--; )
	{
		...
		SDL_Rect rect = {static_cast<Sint16>(v.fX), static_cast<Sint16>(v.fY),
							  static_cast<Sint16>(v.wSize), static_cast<Sint16>(v.wSize)};
