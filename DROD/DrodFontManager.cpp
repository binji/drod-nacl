// $Id: DrodFontManager.cpp 10026 2012-03-28 05:23:48Z mrimer $
...
static const SDL_Color AlmostWhite = {255, 254, 255, 0}; //needed for black outlining to work
...
bool CDrodFontManager::LoadFonts()
{
	...
	this->LoadedFonts[F_TitleMarquee].bAntiAlias = false;
	...
	this->LoadedFonts[F_TitleMarqueeHyperlink].bAntiAlias = false;
	...
	this->LoadedFonts[F_TitleMarqueeActiveHyperlink].bAntiAlias = false;
	...
	this->LoadedFonts[F_Stats].bAntiAlias = false;
	...
	this->LoadedFonts[F_TitleMenu].bAntiAlias = false;
	...
	this->LoadedFonts[F_TitleMenuActive].bAntiAlias = false;
	...
	this->LoadedFonts[F_TitleMenuSelected].bAntiAlias = false;
